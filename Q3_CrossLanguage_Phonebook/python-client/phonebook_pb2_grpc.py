...
class PhonebookServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetContact = channel.unary_unary(
                '/phonebook.PhonebookService/GetContact',
                request_serializer=phonebook__pb2.ContactRequest.SerializeToString,
                response_deserializer=phonebook__pb2.ContactResponse.FromString,
                _registered_method=True)
        ...
        self.ListContacts = channel.unary_unary(
                ...
                response_deserializer=phonebook__pb2.ContactList.FromString,
                _registered_method=True)
...
def add_PhonebookServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListContacts': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=phonebook__pb2.ContactList.SerializeToString,
            ),
    }
...
class PhonebookService(object):
    ...
    def ListContacts(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            phonebook__pb2.ContactList.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
